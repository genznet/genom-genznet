...
echo -e "${GREEN}│PILIH NOMOR${NC} ${CYAN}[11] ${WH}🌐 WILDCARD CLOUDFLARE 🌐        ${GREEN} ${NC}│"
echo -e "${GREEN}│PILIH NOMOR${NC} ${CYAN}[12] ${WH}🔍 MELIHAT USER YANG ONLINE 🔍  ${GREEN}  ${NC}│"
echo -e "${GREEN}╰══${GREEN}══════════════════${GREEN}═════════${GREEN}══════════════════════${GREEN}╯${NC}"

echo -e "${RED}╭═══════${RED}══════ • ${RED}GENOM SCRIPT PRO${RED} • ${RED}════════════════╮${NC}"
echo -e "${RED}│PILIH NOMOR${NC} ${CYAN}[15]    ${WH}🧬 AKSESS GENOM PRO ADMIN 🧬 ${NC} $COLOR1│"
echo -e "${RED}╰══${RED}════════════════${RED}═════════${RED}════════════════════════${RED}╯${NC}"

echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ ${WH}Traffic${NC}      ${WH}Today     Yesterday       Month      $COLOR1│ ${NC}"
echo -e "$COLOR1│ ${COLOR1}Total${NC}    ${COLOR1}  $todayd $today_v    $yesterday $yesterday_v     $month $month_v$COLOR1  │ ${NC} "
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"

echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ $NC ${WH}Versi Script  ${COLOR1}: ${WH}$(cat /opt/.ver) Latest Version               $COLOR1│ ${NC}"
echo -e "$COLOR1│ $NC ${WH}Author        ${COLOR1}: ${WH}GENZNET VPN STORE                $COLOR1│ ${NC}"
echo -e "$COLOR1│ $NC ${WH}Client        ${COLOR1}: ${WH}$client_name                          $COLOR1│ ${NC}"
echo -e "$COLOR1│ $NC ${WH}Sisa Hari     ${COLOR1}: ${WH}$days_remaining hari                       $COLOR1│ ${NC}"
echo -e "$COLOR1│ $NC ${WH}Expire Date   ${COLOR1}: ${WH}$exp_date                       $COLOR1│ ${NC}"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e ""
