...
echo -e "$COLOR1│ $NC${WH}❈ IP-VPS             ${COLOR1}: ${WH}$IPVPS             ${COLOR1}│${NC}"
echo -e "$COLOR1│ $NC${WH}❈ Uptime             ${COLOR1}: ${WH}$SERONLINE       ${COLOR1}│${NC}"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
...
echo -e "${GREEN}│${WH}PILIH NOMOR${NC} ${CYAN}[12] ${WH}🔍 MELIHAT USER YANG ONLINE 🔍  ${GREEN}  │${NC}"
